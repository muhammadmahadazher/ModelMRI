...
# Moved to `devices`, where the other hardware reads live. Imported by
# name so every existing call site here reads unchanged.
from .devices import _ram_bytes  # noqa: E402
